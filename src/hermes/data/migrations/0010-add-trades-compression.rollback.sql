-- migration: 0010-add-trades-compression (rollback)
-- description: Remove trades compression policy, decompress any existing chunks,
...
SELECT decompress_chunk(c) FROM show_chunks('trades') c;
